...
# auth_info
SLACK_TOKEN = 'xoxb-677130169825-692392862112-VtgUzrR4qT7tnJ77OHsdg8N6'
SLACK_SIGNING_SECRET = 'c725eb3defee4faf8ac188c949159e85'
...
def _papago(text, channel):
    ...
    if trans[idx] in text:
        ...
        block2 = SectionBlock(
            #text="`@`"+"`ssapago <명령어>, <문장>` 의 형태로 멘션해주세요."
            text="`<@봇이름> <명령어>, <문장>` 의 형태로 멘션해주세요."+"\n`봇이름 => ssapago`" 
        )
